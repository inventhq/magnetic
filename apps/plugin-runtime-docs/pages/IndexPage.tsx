...
export function IndexPage(props: any) {
  return (
    <div class="row min-h-screen" key="page">
      <Head>
        <title>{props.title} — Plugin Runtime Docs</title>
        <meta name="description" content={props.description} />
      </Head>

      <aside class="docs-sidebar" key="sidebar">
        <div class="stack gap-xs p-lg border-b" key="logo">
          <h1 class="text-xl bold fg-heading" key="brand">Plugin Runtime</h1>
          <span class="text-xs fg-muted" key="tagline">Event-Driven Plugin Engine</span>
        </div>
