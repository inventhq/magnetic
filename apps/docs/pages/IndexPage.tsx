...
export function IndexPage(props: any) {
  return (
    <div class="row min-h-screen" key="page">
      <Head>
        <title>{props.title} — Magnetic Docs</title>
        <meta name="description" content={props.description} />
      </Head>

      <aside class="docs-sidebar" key="sidebar">
        <div class="stack gap-xs p-lg border-b" key="logo">
          <h1 class="text-xl bold fg-heading" key="brand">Magnetic</h1>
          <span class="text-xs fg-muted" key="tagline">Server-Driven UI Framework</span>
        </div>
        ...
        <div class="stack gap-sm p-md border-t" key="links">
          ...
          <a href="https://www.npmjs.com/package/@magneticjs/cli" class="nav-link" key="npm-cli">npm: @magneticjs/cli</a>
