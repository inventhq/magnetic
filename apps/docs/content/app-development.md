...
description: Pages, state, actions, data sources, authentication, and deployment reference.
layout: docs
order: 2
---

# Magnetic App Development Reference

Magnetic is a server-driven UI framework where the server owns all state and rendering. The client is a ~2KB rendering shell with zero framework JS.
