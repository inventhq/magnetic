...
description: Build server-driven UI apps with TSX. Everything you need to get started.
layout: docs
order: 1
---
...
> Build server-driven UI apps with TSX. This guide covers everything you need to get started.
