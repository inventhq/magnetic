...
description: Building reusable UI components for Magnetic apps.
layout: docs
order: 3
---
...
- [App Development Reference](https://docs.magnetic.dev/app-development) — Pages, state, actions, data sources
